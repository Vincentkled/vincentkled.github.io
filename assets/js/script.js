...
const pengirim = "Vincent";
const nomorWa = "6285156404021"; // awalan nomor 0 harus di awalin 62
const textWa = "Tolong Konfirmasi nama kamu ya :"
const pesan = `gapapasih, cuma kasih tau itu aja, jangan lupa kirim data ya!`;
...
hilang1.addEventListener('click', () => {
  ...
  Swal.fire({
    ...
    imageHeight: 120,
    title: 'Coba kasih tau nama kamu biar aku cek',
    ...
    preConfirm: () => {
      ...
      if (!login) {
        Swal.showValidationMessage(`heh jangan dikosongin, cepet masukin nama kamu`)
      }
      return { login }
    }
  }).then((result) => {
    if (result.isConfirmed) {
      ...
      // Kembali ke menu sebelumnya jika tidak ada tindakan
      messege1.style.display = "block";
      messege1.style.transform = "translateX(0)";
      btnPlay.style.display = "none";
      hilang1.style.display = "block";
